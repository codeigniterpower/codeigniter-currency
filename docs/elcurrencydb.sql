...
INSERT INTO `cur_moneda` (`cod_moneda`, `iso4217a3`, `simbolo_unicode`, `nombre_moneda`, `estado`, `notas_pais`, `sessionflag`, `sessionficha`) VALUES ('950', 'XAF', '₣', 'CFA Franc BCEAO', 'ACTIVO', 'Benin Burkina Faso Cameroon Central African Republic Chad Congo (Brazzaville) Côte d\'Ivoire Equatorial Guinea Gabon Guinea-Bissau Mali Niger Senegal Togo', '', '');
